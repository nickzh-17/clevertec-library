...
export const SmartBookImage = ({book, className}) => {
    let content = null;

    if( !book.imageSource ) content = <div className='image-bypass'>
    ...
    if( book.imageSource ) content = <img src={book.imageSource} alt='book' />;
