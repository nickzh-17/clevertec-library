...
export const SearchBar = ({isSearchOpen, onSearchIconClick}) => {
    ...
    if( currentWidth < 768  ) {
        ...
        return <div>
            ...
            <div className={`search-bar mobile ${isSearchOpen ? 'visible' : ''}`}>
                ...
                <input data-test-id='input-search' ref={inputRef} type="text" placeholder='Поиск книги или автора...' />
                <button data-test-id='button-search-close' type='button' onClick={onSearchIconClick}>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
